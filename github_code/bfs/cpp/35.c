...
public:
      ...
      int *queue, **adjMatrix;
      struct node *vertices[100];   // alternative unknown //
      ...
      void breadthFirstSearch() {
            ...
            while(isQueueEmpty()) {
                  int tempVertex = queueRemove();

                  while((unvisited = adjacentUnvisitedVertex(tempVertex)) != -1) {
...
int main(int argc, char const *argv[]) {
      // This program demostrates Breadth-First-Search on a Graph
