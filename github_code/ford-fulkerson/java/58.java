 ...
 *  Compilation:  javac com.dzhou.corejava.algs4.FordFulkerson.java
 *  Execution:    java com.dzhou.corejava.algs4.FordFulkerson V E
 *  Dependencies: com.dzhou.corejava.algs4.FlowNetwork.java com.dzhou.corejava.algs4.FlowEdge.java com.dzhou.corejava.algs4.Queue.java
 *
...
/**
 *  The <tt>com.dzhou.corejava.algs4.FordFulkerson</tt> class represents a data type for computing a
...
public class FordFulkerson {
        ...
        for (int v = 0; v < G.V(); v++) {
            for (FlowEdge e : G.adj(v)) {
                if (e.flow() < -EPSILON || e.flow() > e.capacity() + EPSILON) {
                    System.err.println("com.dzhou.corejava.algs4.Edge does not satisfy capacity constraints: " + e);
                    return false;
                }
            }
        }
    ...
    /**
     * Unit tests the <tt>com.dzhou.corejava.algs4.FordFulkerson</tt> data type.
     */
