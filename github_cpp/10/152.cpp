                                        ...
                                        const char * str2, uint32_t len2 )
{
 ...
 uint32_t LevenshteinDistance::Distance( const char * lhs, const char * rhs )
{
 ...
 uint32_t LevenshteinDistance::Distance( const AString & lhs, const AString & rhs )
{
 ...
 uint32_t LevenshteinDistance::DistanceI( const char * lhs, const char * rhs )
{
    const uint32_t lhsLen = ( nullptr == lhs ) ? 0 : ( uint32_t ) AString::StrLen( lhs );
    const uint32_t rhsLen = ( nullptr == rhs ) ? 0 : ( uint32_t ) AString::StrLen( rhs );
 ...
 uint32_t LevenshteinDistance::DistanceI( const AString & lhs, const AString & rhs )
{
