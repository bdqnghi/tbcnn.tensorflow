...
protected:
    ...
    typedef std::unordered_map<std::string, cache_list_t::iterator> cache_map_t; // main store
...
public:
    ...
    void printr()
    {
        ...
        {
            std::cout << i.first << " , " ;//<< " : " << i.second.m_value << ", " ;
        }
        std::cout << "\n";
    }
};
...
lru->printr();
//item i = lru->get("key-1");
//std::cout << " get value " << i.m_value << " \n";
return 0;
}
