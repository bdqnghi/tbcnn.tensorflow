...
int main(){
  ...
  array6[500],array7[500],array8[500],array9[500],array0[500];                           		
  int sarray[1000],sarray2[1000],sarray3[1000],sarray4[1000],sarray5[1000],
  sarray6[1000],sarray7[1000],sarray8[1000],sarray9[1000],sarray0[1000];                        
  int marray[2500],marray2[2500],marray3[2500],marray4[2500],marray5[2500],
  marray6[2500],marray7[2500],marray8[2500],marray9[2500],marray0[2500];                        
  int larray[5000],larray2[5000],larray3[5000],larray4[5000],larray5[5000],
  larray6[5000],larray7[5000],larray8[5000],larray9[5000],larray0[5000];                        



  int n = sizeof(array)/sizeof(array[0]);   	
  int o = sizeof(sarray)/sizeof(sarray[0]);   	
  int p = sizeof(marray)/sizeof(marray[0]);   	
  int q = sizeof(larray)/sizeof(larray[0]);   	
