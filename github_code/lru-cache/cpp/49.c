...
class LRUCache
{
	...
	Mapped* get(const Key& key)
	{
		...
		if(it == cache_map_.end())
			return NULL;
		//move entry to the head of the list, add update some information of Mapped in its Construction.
	...
	// type Mapped must have a member function invalid(). 
	void cleanup()
	{
	...
	// only for debug, type Mapped must implete << operator.
	void print()
	{
