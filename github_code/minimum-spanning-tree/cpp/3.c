...
//----------------------Below mentioned code section is client code to test the algorithm-----------
//--------------------------------------------------------------------------------------------------
void test_01()
{
...
/*
compilation 
  g++ -std=c++11 ../../../NonTemplate/ListImpl/Graph_linked_list_inpl.hpp ../../../NonTemplate/ListImpl/Graph_linked_list_inpl.cpp minimum_spanning_tree_Prims.cpp
*/