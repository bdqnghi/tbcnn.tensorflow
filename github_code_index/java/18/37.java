//*************************************************************
//  TwoSorts.java       Author: Casey Proud
//  Assignment 7
//  Due: 11/24/2015
//	CS 111B
//  Draws vertical bars and sorts them one at a time using the "pass" button.

//  Declare class's variables
// +init loads class into system, further sets up applet, and initializes array with random numbers
// +paint graphics and set up sorting algorithms
// +set up button to increment indices
// +set up bounds checking to ensure program is finished
//*************************************************************
	 ...
	 public void paint (Graphics page)
	   {
		 ...
		 min = index;
			...
			//Implements what button does when clicked
