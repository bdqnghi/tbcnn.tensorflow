...
def _pad_batch_siamese_2_side(batch_left_nodes, batch_left_children, batch_right_nodes, batch_right_children, labels):
    ...
    left_masks, right_masks = _produce_mask_vector_2_side(batch_left_nodes, batch_right_nodes, max_nodes)
    batch_left_nodes, batch_left_children = _pad_batch_siamese(batch_left_nodes, batch_left_children, max_nodes)
    batch_right_nodes, batch_right_children = _pad_batch_siamese(batch_right_nodes, batch_right_children, max_nodes)
...
def _produce_mask_vector(nodes, max_nodes):
    ...
    padded = pad_sequences(masks)
    return padded

def _produce_mask_vector_2_side(left_nodes, right_nodes, max_nodes):
    # print(nodes)
    
    left_masks = _produce_mask_vector(left_nodes,max_nodes)
    right_masks = _produce_mask_vector(right_nodes,max_nodes)
