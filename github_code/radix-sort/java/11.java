...
public class Radixsort {
	...
	private static String getIthDigit(String a, int i) {
		// System.out.println(a + ", " + i + " = " + Integer.valueOf(a.substring(a.length() - i - 1, a.length() - i)));
	...
	private static String incrementNumber(String s) {
		// System.out.print("Increment " + s + " by 1: ");
	...
	private static String decrementNumber(String s) {
		// System.out.print("Decrement " + s + " by 1: ");
		s = String.valueOf(Integer.valueOf(s) - 1);
		while (s.length() < D)
			s = "0" + s;
		// System.out.println(s);
	...
	public static void main(String[] args) {
		...
		// Leere bits mit Nullen auff�llen:
