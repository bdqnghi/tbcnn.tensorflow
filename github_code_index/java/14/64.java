...
{  
    ...
    {  
        ...
        private int index;  //存在的话下标是多少
        private V value; //值是多少 
     ...
     */  
    public Tree_B(Comparator<K> kComparator)  
    {  
    ...
    public Tree_B(Comparator<K> kComparator, int t)  
    {  
        this(kComparator);  
        this.t = t;  
        minKeySize = t - 1;  
    ...
    {  
        ...
        Tree_B<Integer, Integer> btree = new Tree_B<Integer, Integer>(3);  
