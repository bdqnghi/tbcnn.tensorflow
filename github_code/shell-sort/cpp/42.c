//  shellsort on an array of ints.
// ------------------------------ Shellsort ------------------------------------
#include <iostream>
#include <ctime>
#include <cstdlib>
using namespace std;
// sorts unsorted array by splitting given array into n-sized columns
// continue this process until one column is left and is sorted, 
// uses insertion sort for actual sorting.
