...
public class Shell extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dataGenLabel.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        ...
        minValueSlider.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        ...
        minValueLabel.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        minValueLabel.setText("Min");

        minTextField.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        ...
        maxValueSlider.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        ...
        maxValueLabel.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        maxValueLabel.setText("Max");

        maxTextField.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        ...
        sequentialButton.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        ...
        elementsField.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
        ...
        generateButton.setFont(new java.awt.Font("Comic Sans MS", 0, 13)); 
    ...
    private void maxValueSliderStateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    private void minValueSliderStateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    private void minTextFieldKeyReleased(java.awt.event.KeyEvent evt) {
        try {
    ...
    private void elementsFieldMousePressed(java.awt.event.MouseEvent evt) {
        if (elementsField.getText().matches(""))
            elementsField.setText("");
    }

    private void sequentialButtonActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            int indices = Integer.parseInt(elementsField.getText());
            data = new int[indices];
            for (int i = 0; i < indices; i++)
    ...
    private void elementsFieldKeyReleased(java.awt.event.KeyEvent evt) {
        try {
    ...
    private void elementsSliderStateChanged(javax.swing.event.ChangeEvent evt) {
    ...
    private void animateSortButtonActionPerformed(java.awt.event.ActionEvent evt) {
