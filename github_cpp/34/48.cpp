...
SelectiveNaiveBayes::SelectiveNaiveBayes(string filename)
{
	m_filename=filename;
	m_input=new Input(2);
...
void SelectiveNaiveBayes::preprocess()
{
	...
	m_input->readingFiles("easy_ham_2",1,0,49,50,1396);
	m_multiInput->readingFiles("spam_2",0,0,49,50,1396);
	m_multiInput->readingFiles("easy_ham_2",1,0,49,50,1396);
