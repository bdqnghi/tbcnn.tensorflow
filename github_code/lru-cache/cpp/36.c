//
//  Generated from Java source code by the Decaf Software translator.
//  WARNING!: Modifications of this file may be overwritten by future translations.
//
...
/*!
 @brief Utility class for small LRU caches.
