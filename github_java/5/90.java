package seidgewick; /*************************************************************************
 *  Compilation:  javac seidgewick.DepthFirstSearch.java
 *  Execution:    java seidgewick.DepthFirstSearch filename.txt s
 *  Dependencies: seidgewick.Graph.java StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/41undirected/tinyG.txt
 *
 *  Run depth first search on an undirected graph.
 *  Runs in O(E + V) time.
 *
 *  % java seidgewick.DepthFirstSearch tinyG.txt 0
 *  0 1 2 3 4 5 6 
 *  NOT connected
 *
 *  % java seidgewick.DepthFirstSearch tinyG.txt 9
 *  9 10 11 12 
 *  NOT connected
 *
 *************************************************************************/
...
/**
 *  The <tt>seidgewick.DepthFirstSearch</tt> class represents a data type for
...
public class DepthFirstSearch {
    ...
    /**
     * Unit tests the <tt>seidgewick.DepthFirstSearch</tt> data type.
     */
