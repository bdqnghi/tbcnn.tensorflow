...
/**
 * Clase MergeSort - Clase que ordena elementos mediante el procedimiento
 * MergeSort
...
public class MergeSort {
	...
	public static <K> void mergeSort(Queue<K> S, Comparator<K> comp) {
		...
		// divide
		Queue<K> S1 = new LinkedQueue<K>(); // (or any queue implementation)
		Queue<K> S2 = new LinkedQueue<K>();
		while (S1.size() < n / 2)
