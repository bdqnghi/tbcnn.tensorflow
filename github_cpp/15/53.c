...
void MyMatrix::helperDivideAndConquer(MyMatrix& firstMatrixClass, MyMatrix& secondMatrixClass,MyMatrix& newMatrixClass,int n){
	...
	helperDivideAndConquer(a11MatrixClass,b11MatrixClass,c11MatrixClass,n/2); 
	...
	helperDivideAndConquer(a12MatrixClass,b21MatrixClass,newerMatrixClass,n/2); 
	...
	helperDivideAndConquer(a11MatrixClass,b12MatrixClass,c12MatrixClass,n/2); 

	MyMatrix b22MatrixClass(secondMatrixClass.squareMatrix,n/2,n/2,n/2);
	helperDivideAndConquer(a12MatrixClass,b22MatrixClass,newerMatrixClass,n/2); 
	...
	helperDivideAndConquer(a21MatrixClass,b11MatrixClass,c21MatrixClass,n/2); 

	MyMatrix a22MatrixClass(firstMatrixClass.squareMatrix,n/2,n/2,n/2);
	helperDivideAndConquer(a22MatrixClass,b21MatrixClass,newerMatrixClass,n/2); 
	...
	helperDivideAndConquer(a21MatrixClass,b12MatrixClass,c22MatrixClass,n/2); 

	helperDivideAndConquer(a22MatrixClass,b22MatrixClass,newerMatrixClass,n/2); 
...
void MyMatrix::helperStrassen(MyMatrix& firstMatrixClass, MyMatrix& secondMatrixClass,MyMatrix& newMatrixClass,int n){
	if(n<=THRESHOLD){
		...
		subtractMatrix(b12MatrixClass,b22MatrixClass,tempClass,n/2);	
		helperStrassen(a11MatrixClass,tempClass,R,n/2);	
		...
		subtractMatrix(b21MatrixClass,b11MatrixClass,tempClass,n/2);	
		helperStrassen(a22MatrixClass,tempClass,S,n/2);	
		...
		addMatrix(a11MatrixClass,a12MatrixClass,tempClass,n/2);	
		helperStrassen(tempClass,b22MatrixClass,T,n/2);	
		...
		addMatrix(a11MatrixClass,a22MatrixClass,tempClass,n/2);	
		addMatrix(b11MatrixClass,b22MatrixClass,tempClass2,n/2);	
		helperStrassen(tempClass,tempClass2,P,n/2);	
		...
		addMatrix(a21MatrixClass,a22MatrixClass,tempClass,n/2);	
		helperStrassen(tempClass,b11MatrixClass,Q,n/2);	
		...
		subtractMatrix(a21MatrixClass,a11MatrixClass,tempClass,n/2);	
		addMatrix(b11MatrixClass,b12MatrixClass,tempClass2,n/2); 
		helperStrassen(tempClass,tempClass2,U,n/2);	
		...
		subtractMatrix(a12MatrixClass,a22MatrixClass,tempClass,n/2);	
		addMatrix(b21MatrixClass,b22MatrixClass,tempClass2,n/2); 
		helperStrassen(tempClass,tempClass2,V,n/2);	
