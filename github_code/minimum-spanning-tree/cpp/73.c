...
private:
    Vertex findSmallestWeightedVertex(bool const[]) const; // find non-visited
};
 ...
 *******************************************************************************/
template <typename Vertex, int size>
Vertex MinimumSpanningTree<Vertex, size>::findSmallestWeightedVertex(bool const visited[]) const
{
    Vertex k = source;
