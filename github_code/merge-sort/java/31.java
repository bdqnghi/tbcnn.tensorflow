...
//    	BufferedReader bf = new BufferedReader(new FileReader("F:\\E-Books + Learning stuff\\Coursera-Algorithms\\Algorithms I\\Algorithms-DATA\\algs4-data\\words3.txt"));
...
//    	}   	
//    	
//    	String[] a = text.toString().split("\\p{javaWhitespace}+");
