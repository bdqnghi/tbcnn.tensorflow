...
std::pair<int, std::string> test_mst_dense_prim(std::ostream& strm,int argc, const char *argv[])
{
      ...
      s10.insert(simple_edge_t(0,1,0.32));
      s10.insert(simple_edge_t(0,2,0.29));
      s10.insert(simple_edge_t(0,6,0.51));
      s10.insert(simple_edge_t(5,3,0.18));
      s10.insert(simple_edge_t(7,4,0.46));
      s10.insert(simple_edge_t(5,4,0.40));
      s10.insert(simple_edge_t(0,5,0.60));
      s10.insert(simple_edge_t(6,4,0.51));
      s10.insert(simple_edge_t(7,0,0.31));
      s10.insert(simple_edge_t(7,6,0.25));
      s10.insert(simple_edge_t(7,1,0.21));
      s10.insert(simple_edge_t(4,3,0.34));
