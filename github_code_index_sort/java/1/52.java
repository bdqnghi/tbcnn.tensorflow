...
public class MergeSortCountInversions {
    ...
    // END OF INSERTION-SORT IMPLEMENTATION
    ...
    public static void main( String[] args ) {
        ...
        /* int insertionSortExchangeCount = insertionSort( intArr );

        StdOut.println( "DEBUG: intArr (AFTER : exchanges: " + insertionSortExchangeCount + "): " +
