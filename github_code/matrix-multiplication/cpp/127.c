/**
Ejercicio II proyeccion Ortogonal
**/
...
void show()
{
	...
	//desplazamiento de los puntos al origine
	...
	//Rotaciones a los nuevos puntos con la matriz
...
int main(int argc, char** argv)
{
	...
	/*Asignacion de memoria  de la matriz de transformacion y translacion*/
	for(int i=0;i<4;i++)
	{
