...
public class Binomial {
    ...
    private final static boolean even(int n) {return (n & 1) == 0;}
	...
	*/
        ...
        System.out.println("comparisons=" + table.comps + ", numR =" + table.numR);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("comparisons = " + table.comps);
        System.out.println("rotations = " + table.numR);
    }
