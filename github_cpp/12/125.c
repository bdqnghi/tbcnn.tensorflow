...
void MinimumSpanningTree::BuildGraph(Game& game)
{
	...
	Node* pNode = new Node(glm::vec2(-300,0.0f)); 
	Node* pNode2 = new Node(glm::vec2(300.0f,0.0f)); 
	Node* pNode3 = new Node(glm::vec2(0.0f)); 
	Node* pNode4 = new Node(glm::vec2(0.0f,150.0f)); 
	Node* pNode5 = new Node(glm::vec2(0.0f, -150.0f)); 
	Node* pNode6 = new Node(glm::vec2(-150.0f,20.0f)); 
	Node* pNode7 = new Node(glm::vec2(150.0f, 20.0f)); 
