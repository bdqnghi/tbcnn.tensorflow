...
public class Dcs_dfs
{
     ...
     */
    public static int cs_dfs(int j, Sparse G, int top, int[] xi, int xi_offset, int[] pstack, int pstack_offset,
            int[] pinv, int pinv_offset)
    {
        ...
        {
            j = xi[xi_offset + head]; /*
                                       * get j from the top of the recursion
                                       * stack
                                       */
            ...
            for (p = pstack[pstack_offset + head]; p < p2; p++) /*
                                                                 * examine all
                                                                 * neighbors of
                                                                 * j
                                                                 */
            {
                ...
                pstack[pstack_offset + head] = p; /*
                                                   * pause depth-first search of
                                                   * node j
                                                   */
