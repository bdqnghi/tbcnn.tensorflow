	...
	: QMainWindow(parent)
{
	...
	/* Wygl�d g��wnego okna*/
	QWidget *centralWidget = new QWidget; // centralny wid�et
	QWidget *table = new QWidget; // niewidzialna przestrze� nad ustawieniami 
	QWidget *timers = new QWidget;
	QVBoxLayout *mainLayout = new QVBoxLayout; // g��wny wygl�d
	QHBoxLayout *settingsLayout = new QHBoxLayout; // wygl�d ustawie� 
	QGroupBox *settings = new QGroupBox; // GroupBox ustawie�
	...
	QGroupBox *settingsBubblesort = new QGroupBox; // GroupBox ustawie� sortowania b�belkowego
	QVBoxLayout *settingsBubblesortLayout = new QVBoxLayout; // wygl�d groupboxa sortowania b�belkowego
	...
	QGroupBox *settingsInsertionsort = new QGroupBox; // GroupBox ustawie� sortowania przez wstawiania
	QVBoxLayout *settingsInsertionsortLayout = new QVBoxLayout; // wygl�d groupboxa sortowania przez wstawianie
	...
	QGroupBox *settingsSelectionsort = new QGroupBox; // GroupBox ustawie� sortowania przez wymian�
	QVBoxLayout *settingsSelectionsortLayout = new QVBoxLayout; // wygl�d groupboxa sortowania przez wymian�
	...
	QGroupBox *settingsHeapsort = new QGroupBox; // GroupBox ustawie� sortowania przez wymian�
	QVBoxLayout *settingsHeapsortLayout = new QVBoxLayout; // wygl�d groupboxa sortowania przez wymian�


														   /* Po��czenie sygna��w i slot�w*/
...
void MyClass::sortBubblesort()
{
	if (isstopedBubbleSort == 0) {
		...
		if (bubblesortP < 35)
		{
			if (bubblesortTable[bubblesortP] > bubblesortTable[bubblesortP + 1])// je�li element tablicy jest wi�kszy od nast�pnego elementu
			{
				bubblesortZamiana = true; //je�li jest jaka� zmiana, to zmienne zamiana powi�ksza swoj� warto��
				schowekBubblesort = bubblesortTable[bubblesortP];//warto�� t[i] jest kopiowana do schowka
				bubblesortTable[bubblesortP] = bubblesortTable[bubblesortP + 1];//t[i] przyjmuje warto�� nast�pnego elementu, gdy� jest on mniejszy
				bubblesortTable[bubblesortP + 1] = schowekBubblesort;//kolejny element tablicy przejmuje wcze�niejsz� warto�� poprzedniego elementu, gdy� jest on wi�kszy
				update();
			}
			bubblesortP++;
		}
...
void MyClass::sortSelectionsort() {
	if (isstopedSelectionSort == 0) {
		...
		{
			max = selectionsortI; // indeks najmniejszego znalezionego elementu
			for (j = selectionsortI + 1; j < 35; j++) // poszukujemy najmniejszego elementu poczawszy od i
			{
				if (selectionsortTable[j] < selectionsortTable[max]) // jezeli znalezlismy mniejszy element zapisujemy jego indeks w max
					max = j;
			}
