...
public class Controller {
	...
	/**
	 * Recebe a matriz, posi��o inicial e final da matriz para efetuar a
	 * ordena��o. Define o "meio" da lista e separa em duas outras listas at�
	 * organizar toda a matriz.
	 * 
	 * @param quickSort
	 * @param ini
	 * @param fim
	 ...
	 * @param ini
	 * @param fim
	 * @return Retorna a posi��o central da matriz
	 */
	...
	/**
	 * Percorre a matriz comparando todas as suas posi��es at� ordenar todas
	 * a matriz.
	 * 
	 * @param insertionSort
