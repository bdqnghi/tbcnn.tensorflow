...
int main(int argc, char* argv[]){
    ...
    if(testAVLB) //TEST Balance AVL-Tree
    {
        testingAVLB(testNumbers,numbersToDelete, testNum);
    }
    if(testAVLH) //TEST Height AVL-Tree
    {
        testingAVLH(testNumbers,numbersToDelete, testNum);
    }
    if(testRB) //TEST Red-Black AVL-Tree
    {
...
void writeSyntax()
{
    ...
    // std::cout << "The third Argument should be the name of the output file" << std::endl;
