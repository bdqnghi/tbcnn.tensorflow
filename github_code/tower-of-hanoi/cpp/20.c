...
// TowerOfHanoi.cpp : Defines the class behaviors for the application.
//
...
// The one and only CTowerOfHanoiApp object

CTowerOfHanoiApp theApp;


// CTowerOfHanoiApp initialization
...
// CTowerOfHanoiApp message handlers
