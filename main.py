...
parser.add_argument('--n_classes', type=int, default=24, help='manual seed')
parser.add_argument('--train_directory', default="github_cpp_pkl_train_test_val/train", help='train program data')
parser.add_argument('--test_directory', default="github_cpp_pkl_train_test_val/test", help='test program data')
parser.add_argument('--val_directory', default="github_cpp_pkl_train_test_val/val", help='validation program data')
