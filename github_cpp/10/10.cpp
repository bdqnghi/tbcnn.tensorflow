...
TEST(LevenshteinDistance, CombinedSubstitutionAndDeletionUntilEqual) {
    ...
    EXPECT_EQ(2, levenshteinDistance("kitting", "kitten")); 
    EXPECT_EQ(1, levenshteinDistance("kitteng", "kitten")); 
    EXPECT_EQ(0, levenshteinDistance("kitten", "kitten")); 

    EXPECT_EQ(3, levenshteinDistance("Sunday", "Saturday"));
    EXPECT_EQ(2, levenshteinDistance("Sunday", "Sturday")); 
    EXPECT_EQ(1, levenshteinDistance("Sunday", "Surday")); 
    EXPECT_EQ(0, levenshteinDistance("Sunday", "Sunday")); 
}
